...
fn take_number(it: &mut Peekable<Chars>) -> Token {
    ...
    // We can not use take_while here, as it always conresultes the next token
...
/// quotation mark.
/// This function asresultes the passed iterator to have the opening quotation
...
/// Takes an identifier or boolean from the characters. The token is asresulted to
